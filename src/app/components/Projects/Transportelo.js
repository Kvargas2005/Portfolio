    ...
    return (
        <div className="mb-8">
            ...
            <p className="text-gray-400 mt-4">
                A shipping and transportation company needed a website where customers could interact and request services within the site. I worked as a frontend and backend developer.            </p>
            <p className="text-gray-400 mt-4">
